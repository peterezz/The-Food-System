...
namespace ECommerce.API.Controllers
{
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<ApplicationUser> userManager, IAouthRepo aouthRepo, UserProfileManager manager, UserManager<ApplicationUser> user, SignInManager<ApplicationUser> signInManager)
        {
